...
PICOVOICE_API_KEY = "zK+X7njg5K7v6kY42tfYiFRuU75JzTugTnoywP4at+CfjghvngvGYw=="  # 你的picovoice key
keyword_path = './speechmodules/Hey-Yuki_en_windows_v3_0_0.ppn'  # 你的唤醒词检测离线文件地址
model_path = '' # 中文模型地址
Baidu_APP_ID = '54570578'  # 你的百度APP_ID
Baidu_API_KEY = 'RSh0wcMlzfWR1VnyHfcD1Qwk'  # 你的百度API_KEY
Baidu_SECRET_KEY = 'NdxrD750KS2YttSWYn1OO9zhmzKfOOZv'  # 你的百度SECRET_KEY
